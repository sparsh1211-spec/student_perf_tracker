            ...
            <div className="ml-16">
                ...
                <div className="flex mt-4">
                    <div className="flex flex-col h-48 pr-12 space-y-2 border-r-2">
                        <div><img src={userProfilePic} alt="avatar" className="rounded-md h-18 w-36"></img></div>
                ...
                <div className="flex space-x-8">
                    <form>
                        <div className="flex flex-col text-sm font-semibold text-gray-600"><label className="pl-2 text-gray-400">Date of Birth*</label>
                            <input placeholder="DOB" className="h-10 pl-2 border-2 border-gray-300 rounded-lg outline-none w-96 " type="" value={userBirthDate+"/"+userBirthMonth+"/"+userBirthYear}></input>
                        </div>
                    </form>
